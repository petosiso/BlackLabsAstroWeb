...
export const portfolioData = [
  {
    ...
    description:
      "Ovládanie kúrenia a regulácie teplej vody. Systém sa prispôsobí tomu, či ste doma, a v noci nemusí bojler zbytočne zohrievať vodu na vysokú teplotu. Zónová smart regulácia.",
    notes: [
